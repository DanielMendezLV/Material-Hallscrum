...
public class EditProyectActivity extends ActionBarActivity {
    private Toolbar toolbar;
    private TextView txtEditName;
    private TextView txtDateProyect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtDateProyect = (TextView) findViewById(R.id.txtdate_proyect);
        Bundle extra = getIntent().getExtras();
        txtEditName.setText(extra.getString("titleProyect"));
        txtDateProyect.setText(extra.getString("titleDate"));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_edit_proyect, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==android.R.id.home){
            ...
            String idProyect = Integer.toString(extra.getInt("idProyect"));

            if(VerificarEditar(nombre)){
                //This works!
                ProgressDialog progress = ProgressDialog.show(EditProyectActivity.this, "Actualizando", "Espere un momento", true);
                String nuevoNombre = txtEditName.getText().toString();
                HallscrumRequests hallscrumRequests = new HallscrumRequests();
                hallscrumRequests.editHallScrum(AddressAPI.URL_PROJECTS,getMapEdit(nuevoNombre,idProyect));
                progress.dismiss();
                startActivity(new Intent(EditProyectActivity.this,MainActivity.class));
            }else{
                startActivity(new Intent(EditProyectActivity.this,MainActivity.class));
            }
        }
